...
const SuccesBox = () => {
  return (
    <div className="test px-8 w-[min(98%,500px)] absolute z-51 top-[35%] left-1/2 -translate-x-1/2 border-4 flex flex-col items-center gap-8 py-4 border-secondary border-t-0 border-r-0 border-b-8 bg-white rounded-3xl">
