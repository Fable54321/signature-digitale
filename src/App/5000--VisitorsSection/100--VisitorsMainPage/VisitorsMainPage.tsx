...
if (sessionSubmissionSuccess) {
  ...
  return (
    ...
    <div className="relative w-full flex justify-between px-4 top-5">
      {languages
        ...
        <button
          ...
          className="bg-secondary z-50 text-white p-2 text-[1.4rem] rounded-sm font-primary active:scale-75 cursor-pointer"
        >
          {label}
        </button>
      ))}
...
<div className="relative mb-10">
      <h2 className="text-[3.5em] font-bold font-primary text-secondary text-center leading-tight">
        
        { language === 'fr' && 'Registre des visiteurs' }
        { language === 'es' && 'Registro de visitantes' }
        { language === 'en' && 'Visitor Log' }
